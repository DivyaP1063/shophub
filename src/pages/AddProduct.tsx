...
const AddProduct = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!token || user?.role !== 'seller') {
      toast({
        title: "Error",
        description: "You must be logged in as a seller to create products",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      await dispatch(createProduct({ productData: productFormData, token })).unwrap();
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Create a new product for your fashion store.</p>
      </div>
